...
- **Status**: v4 (robust sharing) LIVE at **https://yeson4a.org**
  ...
  (Decision 062).
- **Brand**: official Yes on 4A logo landed 2026-09-09 (masters in
  `branding/yes-on-4a/`, all rasters generated by
  `tools/render_brand_assets.py`). Header lockup swaps light/dark; the
  site finally has a favicon + PWA icons (it had none). The retired
