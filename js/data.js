...
const CAMPAIGN = {
   ...
   * `forums` above and never merged with them. Same offer as the
   * district forums (informational, come learn and ask questions);
   * what differs is who runs the room. Listing a campaign event as a
   ...
   * Confirmed with the campaign organizer 2026-09-09; do NOT re-merge
   * these on the basis that all nine sessions look alike.
   */
  campaignMeetings: {
    ...
    sourceNote: 'Confirmed with the campaign organizer on September 9, 2026. Not yet listed publicly \u2014 check',
    sessions: [
